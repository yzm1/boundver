...
SHA-256 digest. Formula updates are generated from the retained release assets;
the tap does not rebuild the package.
...
The zipapp requires Python 3.9 or newer but no package installation.
