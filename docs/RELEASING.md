...
finite app status `Breezy!`, `Hooray!`, `Keep it up!`, `Keep them coming!`,
`Already looking forward to the next diff.`, or
`More of your lovely PRs please.` A `COMMENTED` review binds that clean body
to its review commit; an
