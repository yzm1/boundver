...
SEMANTIC_RELEASE_TAG = "v0.17.0"
SEMANTIC_RELEASE_MARKER = "semantic-provider-v0.17-release-review/v1"
SEMANTIC_PRODUCT_REVIEW_MARKER = "semantic-provider-v0.17-product-review/v1"
...
with open(os.devnull, "w", encoding="utf-8") as sink:
    with contextlib.redirect_stdout(sink), contextlib.redirect_stderr(sink):
        ...
        result = module.validate_proposal(
            ...
            require_semantic_provider_work=flags[3],
            require_semantic_provider_release=flags[4],
        )
...
def _run_checker(
    ...
    *,
    ...
    require_semantic_provider_work: bool,
    require_semantic_provider_release: bool,
) -> dict[str, Any]:
